...
p = Preference.create!(description: "Less than 100€ ")
p.icon.attach(io: File.open("app/assets/images/icon_pref/euro.png"), filename: "euro.png")

p = Preference.create!(description: "Between 100€ and 200€")
p.icon.attach(io: File.open("app/assets/images/icon_pref/euro.png"), filename: "euro.png")

p = Preference.create!(description: "I don't care till i'm having fun")
p.icon.attach(io: File.open("app/assets/images/icon_pref/euro.png"), filename: "euro.png")
